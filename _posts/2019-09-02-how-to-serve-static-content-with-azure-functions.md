...
![image]({{ site.url }}/images/aad/aad-login.png)
...
![image]({{ site.url }}/images/aad/user-assignment-required.png)

and then add users and/or groups explicitly via the **Users and groups** page:
![image]({{ site.url }}/images/aad/users-and-groups.png)
